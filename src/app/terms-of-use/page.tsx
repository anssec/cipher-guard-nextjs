...
export const metadata = {
  title: "Terms of Use | CipherGuard",
  description: "CipherGuard Terms of Use page.",
};

export default function TermsofUse() {
  return (
    <div className="bg-[#2B2B2B] min-h-screen text-neutral-400 font-poppins selection:bg-[#BFAFF2] selection:text-black">
      <Navbar />
      <main className="md:px-24 px-8 py-12 max-w-5xl mx-auto flex flex-col gap-6">
        <h1 className="text-4xl font-bold text-white mb-2">Terms of Use</h1>

        <p className="text-sm text-neutral-500 uppercase tracking-widest font-bold">Version 1.0</p>

        <p className="text-lg">
          The CipherGuard website located at our domain is a copyrighted work
        ...
        <p className="text-lg p-6 bg-neutral-800 rounded-xl border border-neutral-700 text-neutral-300 shadow-inner">
        ...
        <section className="mt-8 space-y-6">
          <h2 className="text-3xl font-bold text-white border-b border-neutral-700 pb-2">Access to the Site</h2>

          <p>
            <strong className="text-white">Subject to these Terms.</strong> Company grants you a
          ...
          <p>
            <strong className="text-white">Certain Restrictions.</strong> The rights approved to you in
          ...
          <p>
            <strong className="text-white">No Support or Maintenance.</strong> You agree that Company
        ...
        <section className="mt-8 space-y-6">
          <h2 className="text-3xl font-bold text-white border-b border-neutral-700 pb-2">User Content</h2>

          <p>
            <strong className="text-white">User Content.</strong> "User Content" means any and all
          ...
          <p>
            <strong className="text-white">Acceptable Use Policy.</strong> The following terms constitute
          ...
          <p>
            ...
            terminating your Account in accordance with our terms, and/or
        ...
        <section className="mt-8 space-y-6">
          <h2 className="text-3xl font-bold text-white border-b border-neutral-700 pb-2">Third-Party Links & Ads; Other Users</h2>

          <p>
            <strong className="text-white">Third-Party Links & Ads.</strong> The Site may contain links
          ...
          <p>
            <strong className="text-white">Other Users.</strong> Each Site user is solely responsible for
          ...
          <p>
            <strong className="text-white">Cookies and Web Beacons.</strong> Like any other website,
            CipherGuard uses ‘cookies'. These cookies are used
        ...
        <section className="mt-8 space-y-6">
          <h2 className="text-3xl font-bold text-white border-b border-neutral-700 pb-2">Disclaimers</h2>
        ...
        <section className="mt-8 space-y-6">
          <h2 className="text-3xl font-bold text-white border-b border-neutral-700 pb-2">Limitation on Liability</h2>
          ...
          <p>
            <strong className="text-white">Term and Termination.</strong> Subject to this Section, these
        ...
        <section className="mt-8 space-y-6">
          <h2 className="text-3xl font-bold text-white border-b border-neutral-700 pb-2">Copyright Policy.</h2>
          ...
          <ul className="flex flex-col gap-2 ml-6 list-outside list-disc text-neutral-300">
        ...
        <section className="mt-8 space-y-6">
          <h2 className="text-3xl font-bold text-white border-b border-neutral-700 pb-2">General</h2>
          ...
          <p>
            <strong className="text-white">Applicability of Arbitration Agreement.</strong> All claims
          ...
          <p>
            <strong className="text-white">Notice Requirement and Informal Dispute Resolution.</strong>{" "}
            ...
            the Company should be sent to: support@cipherguard.com. After the
          ...
          <p>
            <strong className="text-white">Waiver of Jury Trial.</strong> THE PARTIES HEREBY WAIVE THEIR
          ...
          <p>
            <strong className="text-white">Waiver of Class or Consolidated Actions.</strong> All claims
          ...
          <p>
            <strong className="text-white">Confidentiality.</strong> All aspects of the arbitration
          ...
          <p>
            <strong className="text-white">Severability.</strong> If any part or parts of this
          ...
          <p>
            <strong className="text-white">Right to Waive.</strong> Any or all of the rights and
          ...
          <p>
            <strong className="text-white">Survival of Agreement.</strong> This Arbitration Agreement
            will survive the termination of your relationship with Company.
          </p>

          <p>
            <strong className="text-white">Small Claims Court.</strong> Nonetheless the foregoing, either
            you or the Company may bring an individual action in small claims
            court.
          </p>

          <p>
            <strong className="text-white">Emergency Equitable Relief.</strong> Anyhow the foregoing,
          ...
          <p>
            <strong className="text-white">Claims Not Subject to Arbitration.</strong> Notwithstanding
          ...
          <p>
            <strong className="text-white">Electronic Communications.</strong> The communications between
          ...
          <p>
            <strong className="text-white">Entire Terms.</strong> These Terms constitute the entire
          ...
          <p>
            <strong className="text-white">Your Privacy.</strong> Please read our Privacy Policy.
          </p>

          <p>
            <strong className="text-white">Copyright/Trademark Information.</strong> Copyright ©. All
        ...
        <section className="mt-8 space-y-6 mb-12">
          <h2 className="text-3xl font-bold text-white border-b border-neutral-700 pb-2">Contact Information</h2>
          <p>
            Email:{" "}
            <a href="mailto:support@cipherguard.com" className="text-[#BFAFF2] hover:underline hover:text-white transition-colors">
              support@cipherguard.com
            </a>
          </p>
        </section>
      </main>
