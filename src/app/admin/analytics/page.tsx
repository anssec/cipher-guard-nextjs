...
const MobileSidebarItems = [
  ...
  { icon: <MdAnalytics className="w-5 h-5" />, text: "Analytics", link: "/admin/analytics", active: true },
  ...
  return (
    <main className="flex h-screen overflow-hidden bg-black font-poppins selection:bg-[#BFAFF2] selection:text-black">
      <Sidebar>
        ...
        <SidebarItem icon={<MdAnalytics className="w-5 h-5" />} text={"Analytics"} active={true} link="/admin/analytics" />
