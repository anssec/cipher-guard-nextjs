...
const MobileSidebarItems = [
  ...
  { icon: <HiUsers className="w-5 h-5" />, text: "Users", link: "/admin/users", active: true },
  ...
  return (
    <main className="flex h-screen overflow-hidden bg-black font-poppins selection:bg-[#BFAFF2] selection:text-black">
      <Sidebar>
        ...
        <SidebarItem icon={<HiUsers className="w-5 h-5" />} text={"Users"} active={true} link="/admin/users" />
